...
//! \ingroup imagecommands	
void xDrawImage(size_t image, int x, int y, int frame);
...
//! \ingroup imagecommands
void xRotateImage(size_t image, int angle);
...
//! \ingroup maincommands
void xSetGlobalRotate(int angle);
...
//! \param angle An integer number from 0 to 360 degrees.
//! \ingroup textcommands
void xRotateFont(size_t font, int angle);
